...
// import { Swiper, SwiperSlide } from 'swiper/react';
// import 'swiper/css'; // Swiper CSS-i daxil et

// const AboutValuesComponent = () => {
//   // İki slider-in əlaqəli olmasını təmin etmək üçün ref-lər
...
//         <Swiper
//           onSwiper={setSwiper1} // Sol swiper-in referansını alırıq
//           onSlideChange={(swiper) => {
//             if (swiper2) {
//               swiper2.slideTo(swiper.activeIndex); // Sağ slider-i əlaqələndir
//             }
//           }}
//           slidesPerView={1} // Yalnız bir slayd göstər
//           spaceBetween={10}
//         >
...
//         <Swiper
//           onSwiper={setSwiper2} // Sağ swiper-in referansını alırıq
//           onSlideChange={(swiper) => {
//             if (swiper1) {
//               swiper1.slideTo(swiper.activeIndex); // Sol slider-i əlaqələndir
//             }
//           }}
//           slidesPerView={1} // Yalnız bir slayd göstər
//           spaceBetween={10}
